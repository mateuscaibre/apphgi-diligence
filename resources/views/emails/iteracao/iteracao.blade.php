...
<body style="background-color: #eee; font-family: Arial, Helvetica, sans-serif; max-resolution: 0 auto; padding: 0;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="D7D7D7">
        ...
        <div
            ...
            <h2 style="text-align: center; color: #222;">Nova iteração na plataforma</h2>
        </div>
        ...
        ">
            ...
            <p> O usuário <b>{{$user->name}}</b> enviou o documento abaixo para <b>{{$status}}</b> </p>

            <p>Link do documento: {{$link}}</p>

            <p> <b>Mensagem da plataforma</b> </p>
